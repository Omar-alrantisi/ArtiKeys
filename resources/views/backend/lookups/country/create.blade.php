        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input name="code" id="code" class="form-control" value="{{ old('code')}}" placeholder="@lang('ex: JO')" required/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input name="phone_code" id="phone_code" value="{{ old('phone_code')}}" class="form-control" required/>
                    </div>
                </div><!--form-group-->
